...
static void *
__nif_allocate(size_t size, void * state)
{
...
static void
__nif_deallocate(void * pointer, void * state)
{
  RCUTILS_UNUSED(state);
  enif_free(pointer);
}
...
static void *
__nif_reallocate(void * pointer, size_t size, void * state)
{
  RCUTILS_CAN_RETURN_WITH_ERROR_OF(NULL);
...
static void *
__nif_zero_allocate(size_t number_of_elements, size_t size_of_element, void * state)
{
  RCUTILS_CAN_RETURN_WITH_ERROR_OF(NULL);
