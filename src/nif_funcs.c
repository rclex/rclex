...
static ErlNifFunc nif_funcs[] = {
    ...
    {"rcl_publisher_get_options!", 1, nif_rcl_publisher_get_options, REGULAR_NIF},
    nif_rcl_func(rcl_publisher_fini, 2),
    nif_rcl_func(rcl_publish, 2),
    nif_rcl_func(rcl_subscription_init, 4),
    {"rcl_subscription_get_options!", 1, nif_rcl_subscription_get_options, REGULAR_NIF},
